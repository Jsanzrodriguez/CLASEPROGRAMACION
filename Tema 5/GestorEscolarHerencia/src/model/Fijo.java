...
public final class Fijo extends Profesor implements Inspector, Manifestable {
    ...
    //tiene getter, setter, mostrarDatos, saludar, corregirExamen

    private int pagaExtra;

    private int nHoras;
    //getter setter las variables nuevas
    ...
    public Fijo(String nombre, String apellido, int salario, int nHoras, int pagaExtra) {
        //llama al constructor de la clase con this()
    ...
    public void saludar() {
        super.saludar();
        System.out.println("Chicos, vamos adar la clase, como soy fijo vamos a dar una masterclass");
    }
